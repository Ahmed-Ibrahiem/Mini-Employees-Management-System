...
export const all_form = document.querySelectorAll("form");
export const contact_number_input = document.getElementById("contact_number");
export const email_address_input = document.getElementById("emial_address");
export const zip_code_input = document.getElementById("zip_code");
export const f_name = document.getElementById("f_name");
export const l_name = document.getElementById("l_name");
export const birthday_input = document.getElementById("date_birth");
